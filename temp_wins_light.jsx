            ...
            <section id="why-swap-wins" style={{ padding: '120px 20px', backgroundColor: '#fff', position: 'relative' }}>
                <div style={{ position: 'absolute', top: '0', left: '0', right: '0', height: '100%', backgroundImage: 'radial-gradient(circle at center, rgba(16,185,129,0.03) 0%, transparent 70%)', zIndex: 0 }}></div>
                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                    <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', marginBottom: '80px' }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '12px', padding: '12px 24px', background: 'rgba(16,185,129,0.1)', border: '1px solid rgba(16,185,129,0.2)', borderRadius: '100px', marginBottom: '32px' }}>
                            <Trophy size={18} color="#10b981" />
                            <span style={{ color: '#10b981', fontSize: '0.85rem', fontWeight: '700', letterSpacing: '2px', textTransform: 'uppercase' }}>The Core Advantage</span>
                        </div>
                        <h2 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', color: '#0f172a', fontWeight: '900', letterSpacing: '-1.5px', margin: '0 0 24px 0' }}>
                            Why FitBar <em style={{ color: '#10b981', fontStyle: 'normal' }}>Dominates</em>
                        </h2>
                        <p style={{ color: '#4b5563', fontSize: '1.25rem', maxWidth: '650px', lineHeight: '1.7', fontWeight: '400', margin: 0 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '32px' }}>
                        {[
                            ...
                            onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#fff'; e.currentTarget.style.borderColor = 'rgba(16,185,129,0.3)'; e.currentTarget.style.boxShadow = '0 10px 25px rgba(0,0,0,0.05)'; }} 
                            onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#f8fafc'; e.currentTarget.style.borderColor = '#e2e8f0'; e.currentTarget.style.boxShadow = '0 4px 6px rgba(0,0,0,0.02)'; }}>
                                <div style={{ 
                                    flexShrink: 0,
                                ...
                                <div>
                                    <h3 style={{ fontSize: '1.35rem', fontWeight: '700', color: '#0f172a', marginBottom: '12px', letterSpacing: '-0.5px' }}>{feature.title}</h3>
                                    <p style={{ color: '#4b5563', fontSize: '1.05rem', lineHeight: '1.6', margin: 0, fontWeight: '400' }}>{feature.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
